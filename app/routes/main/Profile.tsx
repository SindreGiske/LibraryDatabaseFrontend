            ...
            <main className={"dashboardBackground"}>
                ...
                <Page.Block gutters width={"lg"}>
                    ...
                    <HGrid gap={"space-12"} columns={2}>
                        ...
                        <VStack className="bookShelf">
                            <Heading size="large" className="w-full text-center">
                                Your loans
                            </Heading>
                            ...
                            {activeLoans.length === 0 ? (
                                ...
                                <>
                                    <Heading size="medium" className="w-full text-center">
                                        Current loans:
                                    </Heading>
                            ...
                            <Heading size="medium" className={"w-full text-center"}>Previous loans:</Heading>
                            {oldLoans?.map((loan) => (
                                <LoanComponent
                                    key={loan.id}
                                    loan={loan}
                ...
                >
                    <Modal.Header closeButton className={"text-center"}>
                        <Heading size={"xlarge"} className={"pl-9"}>{selectedLoan?.title}</Heading>
